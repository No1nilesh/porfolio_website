...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://nileshgautam.onrender.com/send-mail",
        {
          method: "POST",
          headers: {
  ...
  return (
    <>
      ...
      <img
        className="absolute h-96 lg:h-2/3 bottom-0 left-0 opacity-20 "
        src={"/assets/tech2.svg"}
        alt=""
      />
      <img
        className="absolute h-96  lg:h-2/3 opacity-20 right-0 rotate-180 top-0"
        src={"/assets/tech2.svg"}
        alt=""
      />
      <div className="main-box w-full flex flex-col md:flex-row  gap-16 sm:gap-8 px-4 md:p-0 relative z-10 2xl:w-[80%]">
        ...
        <div className="contact-box basis-1/2 flex flex-col justify-center  md:self-start gap-10 md:px-16 mt-16 sm:mt-0">
          <h1 className=" text-lg head_text_color   uppercase">
            Ask your Queries
          </h1>
          <h1
            ref={cRef}
            className="  text-5xl sm:text-6xl md:text-7xl font-bold text-color -mt-7 clip"
          >
            Contact Me.
          </h1>
          {/* watsapp */}
          ...
          <div className="gradient-box custom_shadow w-full rounded-xl cbox">
            <div className="watsapp  bg-[hsla(219,32%,12%,1)] w-full py-10  rounded-xl relative flex justify-center items-center flex-col">
              ...
              <span className="absolute top-[94px] bg-color  rounded-full w-20 h-20 grid place-content-center">
                <a
                  rel="noreferrer"
                  href={"mailto:gautamnilesh084@gmail.com"}
                  target="_blank"
                  aria-label="email"
                >
                  <FontAwesomeIcon
        ...
        >
          <h1 ref={askRef} className="text-2xl font-bold text-color clip">
            Ask Your Queries!{" "}
          </h1>
