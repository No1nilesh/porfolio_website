...
function ResumeButtton() {
  return (
    <div className=" md:absolute right-0 w-16  h-[4.5rem] text-[0.7rem] bg-[hsla(219,32%,12%,1)] outline outline-1 outline-[rgba(255,255,255,0.2)] text-center p-2 rounded-lg scale-75 pointer-events-auto " > 
