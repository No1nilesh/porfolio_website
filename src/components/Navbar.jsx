  ...
  return (
    <nav ref={ref} className='fixed bottom-2  z-50   xl:w-1/3 clip translate-y-20 opacity-0'>
      <ul className='flex gap-6 justify-center items-center  border-gray-600 py-2 px-4 rounded-full  glass xl:gap-12'>
        ...
        <li onClick={() => scrollToSection('about')} className={`cursor-pointer transition-transform ${activeSection === 'about' ? "active" : ''}  ${activeSection === 'home' && firstVisit && !buttonChanged && 'animate-bounce'}`}><FontAwesomeIcon icon={faUser} key={"about"}  style={{ color: "#b9c7df", width: "24px" }} /></li>
